    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">Laporan Pembayaran</div>
...
@section('js')
    ...
    <script>
        ...
        function cetak() {
            ...
            let tgl1 = $('#tgl1').val();
            let tgl2 = $('#tgl2').val();
            window.open('/admin/report/payment/print?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
        }
            ...
            table = $('#my-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'transaction', render: function (data) {
                            console.log(data)
                            return data['amount'] + data['ongkir'] - data['discount'];
                        }},
                    {data: 'user.profiles.name'},
                ],
