    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">List Faq</div>
                <a href="/admin/faq/add" class="btn my-button my-rounded pl-3 pr-3"><i
                    ...
                    @foreach($faq as $v)
                        <tr>
                            ...
                            <td class="text-center">
                                <a data-id="{{ $v->id }}" href="/admin/faq/edit/{{$v->id}}"><i
        ...
        function destroy(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    let res = await $.post('/admin/faq/destroy/'+id, data);
                    Swal.fire(
                        'Deleted!',
